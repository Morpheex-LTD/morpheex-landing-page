...
const FeatureCard = ({
  ...
  return (
    <div className="group relative bg-slate-900/50 border border-white/5 rounded-2xl p-8 hover:border-purple-500/30 transition-all duration-300 overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <h3 className="text-md font-bold mb-3 text-white">{title}</h3>
