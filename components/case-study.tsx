    ...
    <section id="case-study" className="py-24 px-6 relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <Badge className="mb-4 bg-brand-cyan/10 text-brand-cyan border-cyan-500/30 px-4 py-2">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          <div className="bg-gradient-to-br from-slate-900/50 to-slate-800/30 border border-slate-700/50 rounded-xl p-6 backdrop-blur-sm">
            <Building2Icon className="w-8 h-8 text-indigo-400 mb-3" />
          ...
          <div className="bg-gradient-to-br from-slate-900/50 to-slate-800/30 border border-slate-700/50 rounded-xl p-6 backdrop-blur-sm">
            <UsersIcon className="w-8 h-8 text-purple-400 mb-3" />
            <div className="text-sm text-slate-400 mb-1">Scale</div>
            <div className="text-white font-bold text-lg">10M+ Daily Users</div>
          </div>
          <div className="bg-gradient-to-br from-slate-900/50 to-slate-800/30 border border-slate-700/50 rounded-xl p-6 backdrop-blur-sm">
            <ClockIcon className="w-8 h-8 text-cyan-400 mb-3" />
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            {/* Challenge */}
            <div className="bg-gradient-to-br from-red-500/5 to-slate-900/50 border border-red-500/20 rounded-2xl p-8 backdrop-blur-sm">
            ...
            {/* Solution */}
            <div className="bg-gradient-to-br from-indigo-500/5 to-slate-900/50 border border-indigo-500/20 rounded-2xl p-8 backdrop-blur-sm">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={i} className="flex gap-3">
                      <div className="shrink-0 w-6 h-6 rounded-full bg-indigo-500/20 border border-indigo-500/30 flex items-center justify-center mt-0.5">
            ...
            <div className="bg-gradient-to-br from-slate-900/50 to-slate-800/30 border border-slate-700/50 rounded-2xl p-8 backdrop-blur-sm">
          ...
          <div className="space-y-6">
            {/* Key Results Header */}
            <div className="bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 border border-emerald-500/20 rounded-2xl p-6 backdrop-blur-sm">
            ...
            <div className="grid grid-cols-2 gap-4">
              {metrics.map((metric) => (
                <div
                  key={metric.label}
                  className="bg-gradient-to-br from-slate-900/50 to-slate-800/30 border border-slate-700/50 rounded-2xl p-6 hover:border-slate-600/50 transition-all group"
                >
                  <div className="flex flex-col items-center text-center">
                    <div
                      className={`mb-4 p-3 bg-slate-900/80 rounded-xl group-hover:scale-110 transition-transform border border-${metric.color}-500/20`}
                    >
                      {metric.icon}
                    </div>
                    <div
                      className={`text-4xl font-black mb-2 bg-gradient-to-r from-${metric.color}-400 to-${metric.color}-300 bg-clip-text text-transparent`}
                    >
                      {metric.value}
                    </div>
            ...
            {/* CTA Card */}
            <div className="bg-gradient-to-r from-indigo-600 to-cyan-600 rounded-2xl p-8 relative overflow-hidden group cursor-pointer hover:from-indigo-500 hover:to-cyan-500 transition-all">
              ...
              <div className="relative z-10">
                ...
                <Button className="bg-white text-indigo-600 hover:bg-slate-100 font-semibold group/btn">
                  Download Case Study
